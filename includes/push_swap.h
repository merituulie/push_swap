...
t_rotate	*rttnew(char stack, int rotations, int rev_rotate,
				int to_be_pushed);
t_rotate	*rotate_for_biggest_or_smallest_middle(
				t_list *other_end, int size, int previous_value);
t_rotate	*rotate_first_or_last_bs(t_list *first,
				t_list *second, int to_be_pushed);
...
t_rotate	*rotate_or_revrotate(t_list *smaller, int size,
				int to_be_pushed);
int			is_bs(t_list *previous, t_list *next, int biggest,
				int smallest);
int			is_middle(int to_be_pushed, t_list *previous,
				t_list *next);
...
void		rotate_multiple(t_list **head, char stack,
...
void		prtadd_to_parts(t_part **stack, int smallest,
				int biggest, int first_time);
